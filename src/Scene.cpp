...
void Scene::init()
{
	...
	if(!loadLevelInfo(levelFile))
		fatalAssetError("level", levelFile);
...
bool Scene::loadLevelInfo(const string& levelFile) {
	...
	if (line.compare(0, 7, "TILEMAP") != 0)
		fatalAssetError("level", levelFile, "Missing TILEMAP header");
