...
private:
	...
	glm::vec2 position = glm::vec2(0.f), tileMapDispl = glm::vec2(0.f);
	int currentAnimation = -1, currentKeyframe = 0;
	float timeAnimation = 0.f;
	glm::vec2 texCoordDispl = glm::vec2(0.f);
	vector<AnimKeyframes> animations;
	glm::vec2 spriteSize = glm::vec2(0.f);
	glm::vec2 sizeOfEachTile = glm::vec2(0.f);
